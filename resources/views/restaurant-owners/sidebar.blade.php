...
<div class="offcanvas offcanvas-start d-lg-none" tabindex="-1" id="ownerSidebar" aria-labelledby="ownerSidebarLabel">
    ...
    <div class="offcanvas-body">
        <div class="list-group sidebar-menu">
            <a href="{{ route('owner.dashboard') }}" class="list-group-item {{ request()->is('owner/dashboard') ? 'active' : '' }}">
                <i class="fa-regular fa-house me-2"></i>Dashboard
            </a>

            <a href="{{ route('owner.reservations') }}" class="list-group-item {{ request()->is('owner/reservations*') ? 'active' : '' }}">
                <i class="fa-regular fa-calendar me-2"></i>Reservations
            </a>

            <a href="{{ route('owner.orders') }}" class="list-group-item {{ request()->is('owner/orders*') ? 'active' : '' }}">
                <i class="fa-solid fa-truck me-2"></i>Orders
            </a>

            <a href="{{ route('owner.products') }}" class="list-group-item {{ request()->is('owner/products*') ? 'active' : '' }}">
                <i class="fa-solid fa-utensils me-2"></i>Meal Kit
            </a>

            <a href="{{ route('owner.page-management') }}" class="list-group-item {{ request()->is('owner/page-management*') ? 'active' : '' }}">
                <i class="fa-solid fa-globe me-2"></i>Page Management
            </a>

            <a href="{{ route('owner.reviews') }}" class="list-group-item {{ request()->is('owner/reviews*') ? 'active' : '' }}">
                <i class="fa-solid fa-star me-2"></i>Reviews
            </a>
