...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-12 col-lg-9">
            ...
            <form action="{{ route('owner.page-management.updateBasicInfo') }}" method="POST" enctype="multipart/form-data">
             @csrf
             @method('PATCH')
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control form-transparent @error('opening_hours') is-invalid @enderror" id="opening_hours" name="opening_hours" value="{{ old('opening_hours',$restaurant->opening_hours) }}"
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control form-transparent @error('chef') is-invalid @enderror" id="chef" name="chef" value="{{ old('chef',$restaurant->chef) }}"
                ...
                <div class="mb-4">
                    ...
                    <select class="form-select rounded form-transparent" id="category" name="category_id">
                        @foreach ($categories as $category)
                            <option value="{{ $category->id }}"
                                {{ old('category_id', $restaurant->category_id) == $category->id ? 'selected' : '' }}>
                                {{ $category->name }}
                            </option>
                        @endforeach
                    </select>
