    ...
    public function run(): void
    {
        ...
        foreach ($restaurants as $r) {
            $id = DB::table('restaurants')->insertGetId([
                ...
                'email'            => strtolower(preg_replace('/[^\w]/', '', $r['restaurant_name'])) . rand(100,999) . '@tabletrip.jp',
                'phone'            => '000-0000-0000',
            ...
            $restaurantIds[] = ['id' => $id, 'name' => $r['restaurant_name'], 'prefecture' => $r['prefecture'], 'category' => $r['category']];
        }
